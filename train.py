...
tf.flags.DEFINE_string("train_data_file", "./msr_paraphrase_train.txt", "Data source for the positive data.")
tf.flags.DEFINE_string("test_data_file", "./msr_paraphrase_test.txt", "Data source for the positive data.")
